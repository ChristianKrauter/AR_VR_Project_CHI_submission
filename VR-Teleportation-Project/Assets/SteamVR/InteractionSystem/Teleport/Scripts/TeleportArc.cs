...
namespace Valve.VR.InteractionSystem
{
    ...
    public class TeleportArc : MonoBehaviour
    {
        ...
        private LineRenderer actualLineRenderer = new LineRenderer();
        ...
        private void CreateLineRendererObjects()
        {
            ...
            //CHANGE Jonas
            GameObject actualNewObject = new GameObject("actualLineRenderer");
            actualNewObject.transform.SetParent(arcObjectsTransfrom);

            actualLineRenderer = actualNewObject.AddComponent<LineRenderer>();

            actualLineRenderer.receiveShadows = false;
            actualLineRenderer.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;
            actualLineRenderer.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
            actualLineRenderer.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
            actualLineRenderer.material = material;
            //END Change
        ...
        public bool DrawArc(out RaycastHit hitInfo)
        {
            ...
            if (Physics.Linecast(this.transform.position, this.transform.forward, out hitInfo, traceLayerMask))
            {
                this.actualLineRenderer.enabled = true;
                this.actualLineRenderer.positionCount = 2;
                this.actualLineRenderer.SetPosition(0, this.transform.position);
                this.actualLineRenderer.SetPosition(1, hitInfo.point);
                this.actualLineRenderer.enabled = true;
                this.actualLineRenderer.startColor = Color.white;
            }
            /*
            ...
            */
            ...
            /*
            if (false) //CHANGE JONAS arcInvalid -> false
            {
            ...
            */
            return true; //CHANGE JONAS arcHitTime != float.MaxValue;
        }
        ...
        {
            return;
            /*CHANGE for (int i = 0; i < segmentCount; ++i)
            {
#if (UNITY_5_4)
